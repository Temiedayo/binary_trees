...
/**
 * create_node - makees a new levelorder_queue_t node.
...
/**
 * push - Push node to the back of a levelorder_queue_t queue.
...
/**
 * binary_tree_is_complete - scans if a binary tree is complete.
