 ...
 * @head: a Pointer to head of linked list with nodes at 1 level.
 * @func: aPointer to function to call for each node.
 */
void levels_rec(ll *head, void (*func)(int))
{
...
/**
 * append - adds up a new node at the end of a linkedlist
 * @head: a pointer to head of linked list
 * @btnode: const binary tree node to be appended
 ...
 * @head: a pointer to head of list_t linked list
 */
void free_list(ll *head)
{
	ll *ptr = NULL;
